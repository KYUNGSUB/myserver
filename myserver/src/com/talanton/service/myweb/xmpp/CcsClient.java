...
import com.talanton.service.myweb.xmpp.messages.FcmMessage;
...
public class CcsClient {
    ...
    /* XMPP Down Stream 전송에 대한 Ack 응답 */
    public interface GetXmppDownStreamAck {
    	public void callbackXmppAck(int messageId) throws NamingException;
    }
    
    private GetXmppDownStreamAck returnInterface;
    public void registerCallback(GetXmppDownStreamAck callbackClass) {
    	returnInterface = callbackClass;
    }
    ...
    private void handleMessage(String messageJson){
    	System.out.println("handleMessage : " + messageJson);
        try {
            ...
            if ("control".equals(fcmMessage.getMessageType())) {
                ...
                if(returnInterface != null) {
                	try {
						returnInterface.callbackXmppAck(Integer.parseInt(fcmMessage.getMessageId()));
