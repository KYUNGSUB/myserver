...
import com.talanton.service.myweb.fcm.service.SendFcmService;

public class SendFcmAction implements CommandAction {
	private static final String FORM_VIEW = "/fcm/fcmSendForm.jsp";
	...
	private String processSubmit(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		SendFcmService sendService = SendFcmService.getInstance();
