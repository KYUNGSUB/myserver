...
import com.talanton.service.myweb.settings.service.ListSettingItemService;

public class ListParameterAction implements CommandAction {
	...
	private String processForm(HttpServletRequest request, HttpServletResponse response) throws NamingException {
		...
		ListSettingItemService listSerivce = ListSettingItemService.getInstance();
		SettingItemList itemListModel = listSerivce.getSettingItemList(pageNumber);
